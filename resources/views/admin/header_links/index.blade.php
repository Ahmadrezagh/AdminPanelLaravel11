    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="header_link">لینک ها</li>
            </ol>
        </div>
        <div class="d-flex">
        </div>
                    ...
                    <div class="table-responsive" style="min-height: 500px">
                        <table class="table table-bordered" id="example1">
                            ...
                            @foreach($header_links as $header_link)
                                <tr class="text-center">
                                    <td>{{$header_link->title}}</td>
                                    <td><x-form.copiable-component content="{{$header_link->url}}" /></td>
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="dropdown-item" data-toggle="modal" data-target="#modal-edit-{{$header_link->id}}">ویرایش</button>
                                                <button class="dropdown-item" data-toggle="modal" data-target="#modal-destroy-{{$header_link->id}}">حذف</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
